      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-line-chart"></i>Top 20 Movies</h2>
                      ...
                      <table class="table table-datatable table-custom" id="basicDataTable">
                        <thead>
                          <tr>
                            ...
                            <th>Year</th>
                            <th>Director</th>
                            <th>First three genres</th>
                            <th>First three stars</th>
                            <th>Rating</th>
                          </tr>
                        </thead>
                        <tbody>
                        ...
                        <c:param name="starId" value="${tempSt.id}"/>
                                ...
                                <li>   <a href="${starLink}">${tempSt.name}&nbsp</a></li>
